...
export default function RecipeDetail() {
  ...
  const getYouTubeEmbedUrl = (url) => {
    ...
    return match
      ? `https://www.youtube.com/embed/${match[1]}?rel=0&origin=${window.location.origin}`
      : null;
  };
    ...
    <div className="recipe-detail fade-in">
      ...
      <div className="recipe-detail-hero">
        <img
          src={
            recipe.thumbnail ||
            `https://picsum.photos/seed/${recipe.id}/900/400`
          }
          alt={recipe.title}
        />
        <div className="recipe-detail-overlay">
          <div className="recipe-detail-tags">
            {recipe.category && (
              <span className="recipe-tag">🏷️ {recipe.category}</span>
            )}
            {recipe.cuisine && (
          ...
          <div className="recipe-author-compact">
            <img
              src={
                recipe.author_photo ||
                `https://ui-avatars.com/api/?name=${encodeURIComponent(recipe.author_name)}&background=6c5ce7&color=fff&size=30`
              }
        ...
        <div className="recipe-main-content">
          ...
          {(recipe.video_file || embedUrl) && (
            <div className="recipe-section video-section-highlight">
              <h2>
                <span className="sticker">🎥</span> Video Tutorial
              </h2>
              {recipe.video_file ? (
                <video
                  controls
                  ...
                  poster={
                    recipe.thumbnail ||
                    `https://picsum.photos/seed/${recipe.id}/640/360`
                  }
                >
                  <source src={recipe.video_file} />
          ...
          {recipe.description && (
            <div className="recipe-section">
              <h2>
                <span className="sticker">📖</span> About This Recipe
              </h2>
          ...
          {recipe.instructions && (
            <div className="recipe-section">
              <h2>
                <span className="sticker">👨‍🍳</span> Preparation Steps
              </h2>
        ...
        <aside className="recipe-sidebar">
          ...
          {recipe.ingredients && (
            <div className="recipe-section sidebar-section">
              <h3>
                <span className="sticker">🥕</span> Ingredients
              </h3>
