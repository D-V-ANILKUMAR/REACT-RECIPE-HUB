  ...
  return (
    <div className="upload-page fade-in">
      <div className="upload-card">
        <h1>
          <span className="sticker sticker-bounce">✏️</span> Edit Recipe
        </h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label>
              <span className="sticker">🖼️</span> Recipe Thumbnail
            </label>
            <div className="file-upload-zone">
              <div className="sticker" style={{ fontSize: "3rem" }}>
                📷
              </div>
            ...
            {(thumbPreview || existingThumb) && (
              <img
                src={thumbPreview || `${BASE_URL}${existingThumb}`}
                alt="Preview"
          ...
          <div className="form-group">
            <label>
              <span className="sticker">📝</span> Recipe Title
            </label>
            <input
              type="text"
              name="title"
          ...
          <div className="form-group">
            <label>
              <span className="sticker">📖</span> Description
            </label>
            <textarea
              name="description"
          ...
          <div className="form-row">
            <div className="form-group">
              <label>
                <span className="sticker">🏷️</span> Category
              </label>
              <select
                name="category"
            ...
            <div className="form-group">
              <label>
                <span className="sticker">🌍</span> Cuisine
              </label>
              <select
                name="cuisine"
                className="form-select"
          ...
          >
            <div className="form-group">
              <label>
                <span className="sticker">⏱️</span> Cook Time
              </label>
              <input
                type="text"
                name="cook_time"
            ...
            <div className="form-group">
              <label>
                <span className="sticker">🍽️</span> Servings
              </label>
              <input
                type="text"
                name="servings"
            ...
            <div className="form-group">
              <label>
                <span className="sticker">📊</span> Difficulty
              </label>
              <select
                name="difficulty"
                className="form-select"
          ...
          <div className="form-group">
            <label>
              <span className="sticker">🥕</span> Ingredients (one per line)
            </label>
            <textarea
              name="ingredients"
              className="form-textarea"
          ...
          <div className="form-group">
            <label>
              <span className="sticker">👨‍🍳</span> Instructions (one step per
              line)
            </label>
            <textarea
              name="instructions"
          ...
          <div className="form-group">
            <label>
              <span className="sticker">🎬</span> Recipe Video (choose one
              option)
            </label>
            <div className="video-source-tabs">
              <button
                type="button"
                className={`video-tab ${videoSource === "none" ? "active" : ""}`}
                onClick={() => {
                  setVideoSource("none");
                  setVideoFile(null);
              ...
              <button
                type="button"
                className={`video-tab ${videoSource === "file" ? "active" : ""}`}
                onClick={() => {
                  setVideoSource("file");
                  setForm({ ...form, video_url: "" });
                }}
              ...
              <button
                type="button"
                className={`video-tab ${videoSource === "youtube" ? "active" : ""}`}
                onClick={() => {
          ...
          {videoSource === "youtube" && (
            <div className="form-group fade-in">
              <label>
                <span className="sticker">🔗</span> YouTube Video URL
              </label>
              <input
                type="url"
                name="video_url"
