  ...
  return (
    <div className="profile-page fade-in">
      ...
      <div className="profile-form">
        <h2>
          <span className="sticker">✏️</span> Edit Profile
        </h2>
          ...
          <div
            ...
            style={{
              ...
              borderColor: message.startsWith("✅")
                ? "rgba(0,184,148,0.3)"
                : undefined,
              color: message.startsWith("✅") ? "#00b894" : undefined,
            }}
          >
            {message}
          </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label>
              <span className="sticker">📸</span> Profile Photo
            </label>
            <div className="file-upload-zone" style={{ padding: "1.5rem" }}>
              <div className="sticker" style={{ fontSize: "2rem" }}>
                📷
              </div>
          ...
          <div className="form-group">
            <label>
              <span className="sticker">👤</span> Full Name
            </label>
            <input
              type="text"
          ...
          <div className="form-row">
            <div className="form-group">
              <label>
                <span className="sticker">📱</span> Mobile Number
              </label>
              <input
                type="tel"
                className="form-input"
            ...
            <div className="form-group">
              <label>
                <span className="sticker">🎂</span> Age
              </label>
              <input
                type="number"
                className="form-input"
          ...
          <div className="form-group">
            <label>
              <span className="sticker">⚧️</span> Gender
            </label>
            <select
          ...
          <div className="form-group">
            <label>
              <span className="sticker">📧</span> Email (cannot change)
            </label>
            <input
              type="email"
              className="form-input"
          ...
          <div className="form-group">
            <label>
              <span className="sticker">🔒</span> New Password (leave blank to
              keep current)
            </label>
            <input
              type="password"
